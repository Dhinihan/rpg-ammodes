...
> Um personagem com CON 14 pode carregar até 70 lb sem penalidade. Com CON 18, o limite sobe para 90 lb.
...
### Teste de Animal Handling

Sempre que um grupo viajar usando lagartos gigantes, faça **um único teste de Animal Handling** para a viagem inteira.

**DC = 11 + número de dias da viagem**

Em caso de falha, cada ponto de diferença abaixo da DC aumenta o tempo de viagem em 10%. O consumo de água e comida aumenta proporcionalmente.

#### Modificadores

- Se pelo menos dois membros do grupo forem proficientes em Animal Handling, o personagem com o maior bônus pode realizar o teste com **vantagem**.
- Se a quantidade de lagartos for maior que o número de personagens proficientes em Animal Handling, o teste é feito com **desvantagem**. Essa desvantagem se sobrepõe a qualquer vantagem.

> [!example] Exemplo 1 — Falha parcial
> Uma viagem de 5 dias tem DC 16 (11 + 5). O personagem tira 12, falhando por 4 pontos.
> - Aumento do tempo: 4 × 10% = 40%
> - Duração real: 5 × 1,4 = **7 dias**
> - Consumo total de água (1 pessoa + 1 lagarto): 7 × 10 lb = 70 lb
> - Consumo total de comida (1 pessoa + 1 lagarto): 7 × 3 rações = 21 rações

> [!example] Exemplo 2 — Sucesso
> Uma viagem de 3 dias tem DC 14 (11 + 3). O personagem tira 17, passando no teste.
